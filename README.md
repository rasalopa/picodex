...
- 📂 **Open your SD card** directly in the browser (File System Access API) and see your whole library at a glance: games per system, cover coverage, and — if you use [Pico Launcher](https://github.com/LNH-team/pico-launcher) — your favorites and play stats.
